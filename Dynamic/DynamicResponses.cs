...
namespace ScoutingCodeRedo.Dynamic
{
    class DynamicResponses
    {
        ...
        public static void TransactToDatabase(RobotState controller, string recordType)
        {
            ...
            {
                var activity_record = BackgroundCode.activity_record;
                switch (recordType)
                {
                    case ("EndAuto"):
                        ...
                        activity_record.DisAlgae = controller.DisAlgae;
        ...
        public static void ResetValues()
        {
            for (int i = 0; i < 6; i++)
            {
                var robot = BackgroundCode.Robots[i];
