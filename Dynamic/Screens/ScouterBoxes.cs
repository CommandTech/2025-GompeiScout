...
namespace ScoutingCodeRedo.Dynamic
{
    internal partial class ScouterBoxes : Form
    {
        ...
        private void InAutoMode(int Box_Number, int o)
        {
            ...
            ((Label)this.Controls.Find($"lbl{Box_Number}Position0", true)[0]).Visible = (o == 0) || !Settings.Default.practiceMode;
            ...
            {
                ((Label)this.Controls.Find($"lbl{Box_Number}Position0Value", true)[0]).Visible = (o == 0) || !Settings.Default.practiceMode;
            }
            ...
            {
                ((Label)this.Controls.Find($"lbl{Box_Number}Position0Flag", true)[0]).Visible = (o == 0) || !Settings.Default.practiceMode;
            }
            else
            {
            ...
            ((Label)this.Controls.Find($"lbl{Box_Number}Position1", true)[0]).Visible = (o == 0) || !Settings.Default.practiceMode;
            ((Label)this.Controls.Find($"lbl{Box_Number}Position1Value", true)[0]).Text = BackgroundCode.Robots[o].Current_Loc.ToString();
            ((Label)this.Controls.Find($"lbl{Box_Number}Position1Value", true)[0]).Visible = (o == 0) || !Settings.Default.practiceMode;

            // Deliver Destination
            ((Label)this.Controls.Find($"lbl{Box_Number}Position2", true)[0]).Text = "Del:";
            ((Label)this.Controls.Find($"lbl{Box_Number}Position2", true)[0]).Visible = (o == 0) || !Settings.Default.practiceMode;
            ...
            {
                ((Label)this.Controls.Find($"lbl{Box_Number}Position2Value", true)[0]).Visible = (o == 0) || !Settings.Default.practiceMode;
            }
            ...
            {
                ((Label)this.Controls.Find($"lbl{Box_Number}Position2Flag", true)[0]).Visible = (o == 0) || !Settings.Default.practiceMode;
            }
            else
            {
            ...
            ((Label)this.Controls.Find($"lbl{Box_Number}Position3", true)[0]).Visible = (o == 0) || !Settings.Default.practiceMode;
            ...
            {
                ((Label)this.Controls.Find($"lbl{Box_Number}Position3Value", true)[0]).Visible = (o == 0) || !Settings.Default.practiceMode;
            }

            // Leave
            ((Label)this.Controls.Find($"lbl{Box_Number}Position4", true)[0]).Text = "Leave:";
            ((Label)this.Controls.Find($"lbl{Box_Number}Position4", true)[0]).Visible = (o == 0) || !Settings.Default.practiceMode;
            ((Label)this.Controls.Find($"lbl{Box_Number}Position4Value", true)[0]).Visible = (o == 0) || !Settings.Default.practiceMode;
            ...
            ((Label)this.Controls.Find($"lbl{Box_Number}Position5", true)[0]).Visible = (o == 0) || !Settings.Default.practiceMode;
            ((Label)this.Controls.Find($"lbl{Box_Number}Position5Value", true)[0]).Visible = (o == 0) || !Settings.Default.practiceMode;
            ...
            if (BackgroundCode.Robots[o].NoSho == true)
            {
                ...
                ((Label)this.Controls.Find($"lbl{Box_Number}Position6", true)[0]).Visible = (o == 0) || !Settings.Default.practiceMode;
                ...
                else
                {
                    ...
                    ((Label)this.Controls.Find($"lbl{Box_Number}Position6Value", true)[0]).Visible = (o == 0) || !Settings.Default.practiceMode;
                }
            }
            else
            {
        ...
        private void InShowtimeMode(int Box_Number, int o)
        {
            ...
            ((Label)this.Controls.Find($"lbl{Box_Number}Position7", true)[0]).Visible = (o == 0) || !Settings.Default.practiceMode;
            ...
            ((Label)this.Controls.Find($"lbl{Box_Number}Position7Value", true)[0]).Visible = (o == 0) || !Settings.Default.practiceMode;

            ((Label)this.Controls.Find($"lbl{Box_Number}Position8", true)[0]).Text = "Def:";
            ((Label)this.Controls.Find($"lbl{Box_Number}Position8", true)[0]).Visible = (o == 0) || !Settings.Default.practiceMode;
            ...
            else
            {
                ...
                ((Label)this.Controls.Find($"lbl{Box_Number}Position8Value", true)[0]).Visible = (o == 0) || !Settings.Default.practiceMode;
            }

            ((Label)this.Controls.Find($"lbl{Box_Number}Position9", true)[0]).Text = "Mics:";
            ((Label)this.Controls.Find($"lbl{Box_Number}Position9", true)[0]).Visible = (o == 0) || !Settings.Default.practiceMode;
            if (BackgroundCode.Robots[o].Mic == 10 || BackgroundCode.Robots[o].Mic == 9)
            {
                ((Label)this.Controls.Find($"lbl{Box_Number}Position9Value", true)[0]).Visible = false;
            }
            else
            {
                ...
                ((Label)this.Controls.Find($"lbl{Box_Number}Position9Value", true)[0]).Visible = (o == 0) || !Settings.Default.practiceMode;
            }


            ((Label)this.Controls.Find($"lbl{Box_Number}Position10", true)[0]).Text = "Avo:";
            ((Label)this.Controls.Find($"lbl{Box_Number}Position10", true)[0]).Visible = (o == 0) || !Settings.Default.practiceMode;
            ...
            else
            {
                ...
                ((Label)this.Controls.Find($"lbl{Box_Number}Position10Value", true)[0]).Visible = (o == 0) || !Settings.Default.practiceMode;
            }
        }
    }
}
