...
namespace ScoutingCodeRedo.Dynamic
{
    internal partial class ScouterBoxes : Form
    {
        ...
        private void InAutoMode(int Box_Number, int ScouterBox)
        {
            ...
            ((Label)this.Controls.Find($"lbl{ScouterBox}Position0", true)[0]).Visible = (Box_Number < BackgroundCode.gamePads.Length) || !Settings.Default.practiceMode;
            ...
            ((Label)this.Controls.Find($"lbl{ScouterBox}Position0Value", true)[0]).Visible = Box_Number < BackgroundCode.gamePads.Length || !Settings.Default.practiceMode;
            ...
            ((Label)this.Controls.Find($"lbl{ScouterBox}Position1", true)[0]).Visible = Box_Number < BackgroundCode.gamePads.Length || !Settings.Default.practiceMode;

            //Coral
            ((Label)this.Controls.Find($"lbl{ScouterBox}Position2", true)[0]).Text = "Coral:";
            ((Label)this.Controls.Find($"lbl{ScouterBox}Position2", true)[0]).Visible = Box_Number < BackgroundCode.gamePads.Length || !Settings.Default.practiceMode;
            ...
            ((Label)this.Controls.Find($"lbl{ScouterBox}Position2Value", true)[0]).Visible = Box_Number < BackgroundCode.gamePads.Length || !Settings.Default.practiceMode;

            ((Label)this.Controls.Find($"lbl{ScouterBox}Position2Source", true)[0]).Text = BackgroundCode.Robots[Box_Number].lastCoralAcqLoc;
            ((Label)this.Controls.Find($"lbl{ScouterBox}Position2Source", true)[0]).Visible = Box_Number < BackgroundCode.gamePads.Length || !Settings.Default.practiceMode;
            ...
            ((Label)this.Controls.Find($"lbl{ScouterBox}Position2Des", true)[0]).Visible = Box_Number < BackgroundCode.gamePads.Length || !Settings.Default.practiceMode;
            ...
            ((Label)this.Controls.Find($"lbl{ScouterBox}Position3Value", true)[0]).Visible = Box_Number < BackgroundCode.gamePads.Length || !Settings.Default.practiceMode;

            ((Label)this.Controls.Find($"lbl{ScouterBox}Position3Source", true)[0]).Text = BackgroundCode.Robots[Box_Number].lastAlgaeAcqLoc;
            ((Label)this.Controls.Find($"lbl{ScouterBox}Position3Source", true)[0]).Visible = Box_Number < BackgroundCode.gamePads.Length || !Settings.Default.practiceMode;
            ...
            ((Label)this.Controls.Find($"lbl{ScouterBox}Position3Des", true)[0]).Visible = Box_Number < BackgroundCode.gamePads.Length || !Settings.Default.practiceMode;
            ...
            ((Label)this.Controls.Find($"lbl{ScouterBox}Position5Value", true)[0]).Visible = Box_Number < BackgroundCode.gamePads.Length || !Settings.Default.practiceMode;
        ...
        private void InSurfacingMode(int Box_Number, int ScouterBox)
        {
            ...
            //Robot Strategy
            ((Label)this.Controls.Find($"lbl{ScouterBox}Position12", true)[0]).Text = "Strat:";
            ((Label)this.Controls.Find($"lbl{ScouterBox}Position12", true)[0]).Visible = Box_Number < BackgroundCode.gamePads.Length || !Settings.Default.practiceMode;
            ((Label)this.Controls.Find($"lbl{ScouterBox}Position12Value", true)[0]).Text = BackgroundCode.Robots[Box_Number].GetStrat().ToString();
            ((Label)this.Controls.Find($"lbl{ScouterBox}Position12Value", true)[0]).Visible = Box_Number < BackgroundCode.gamePads.Length || !Settings.Default.practiceMode;
            ((Label)this.Controls.Find($"lbl{ScouterBox}Position12Value", true)[0]).ForeColor = System.Drawing.Color.Yellow;
        }
    }
}
