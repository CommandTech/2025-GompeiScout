...
namespace ScoutingCodeRedo.Dynamic
{
    internal partial class ScouterBoxes : Form
    {
       public ScouterBoxes() {
        ...
        private void InAutoMode(int Box_Number, int o)
        {
            // Acquire
            ...
            {
                ((Label)this.Controls.Find($"lbl{Box_Number}Position0Value", true)[0]).Text = BackgroundCode.Robots[o].Acq_Center.ToString();
            }
            else
            {
                ((Label)this.Controls.Find($"lbl{Box_Number}Position0Value", true)[0]).Text = BackgroundCode.Robots[o].Acq_Loc;
            }
            ...
            {
                ((Label)this.Controls.Find($"lbl{Box_Number}Position0Flag", true)[0]).Visible = true;
            }
            else
            {
            ...
            ((Label)this.Controls.Find($"lbl{Box_Number}Position1Value", true)[0]).Text = BackgroundCode.Robots[o].Current_Loc.ToString();
            ((Label)this.Controls.Find($"lbl{Box_Number}Position1Value", true)[0]).Visible = true;
            ...
            ((Label)this.Controls.Find($"lbl{Box_Number}Position2Value", true)[0]).Text = BackgroundCode.Robots[o].Del_Dest.ToString();
            ...
            {
                ((Label)this.Controls.Find($"lbl{Box_Number}Position2Flag", true)[0]).Visible = true;
            }
            else
            {
            ...
            ((Label)this.Controls.Find($"lbl{Box_Number}Position3Value", true)[0]).Text = BackgroundCode.Robots[o].Robot_Set.ToString();
            ...
            if (BackgroundCode.Robots[o].NoSho == true)
            {
                ...
                ((Label)this.Controls.Find($"lbl{Box_Number}Position6", true)[0]).Visible = true;
                ...
                {
                    ((Label)this.Controls.Find($"lbl{Box_Number}Position6Value", true)[0]).Text = BackgroundCode.Robots[o].Mic.ToString();
                    ((Label)this.Controls.Find($"lbl{Box_Number}Position6Value", true)[0]).Visible = true;
                }
            }
            else
            {
        ...
        private void InTeleopMode(int Box_Number, int o)
        {
            ((Label)this.Controls.Find($"lbl{Box_Number}Position0", true)[0]).Text = "Acq:";
            ((Label)this.Controls.Find($"lbl{Box_Number}Position0", true)[0]).Visible = (Box_Number == 0) || !Settings.Default.practiceMode;
            ((Label)this.Controls.Find($"lbl{Box_Number}Position0Value", true)[0]).Text = BackgroundCode.Robots[o].Acq_Loc.ToString();
            ...
            {
                ((Label)this.Controls.Find($"lbl{Box_Number}Position0Value", true)[0]).Visible = (Box_Number == 0) || !Settings.Default.practiceMode;
            }
            ((Label)this.Controls.Find($"lbl{Box_Number}Position0Flag", true)[0]).Text = "D";
            ...
            {
                ((Label)this.Controls.Find($"lbl{Box_Number}Position0Flag", true)[0]).Visible = (Box_Number == 0) || !Settings.Default.practiceMode;
            }
            ...
            ((Label)this.Controls.Find($"lbl{Box_Number}Position1", true)[0]).Text = "Loc:";
            ((Label)this.Controls.Find($"lbl{Box_Number}Position1", true)[0]).Visible = (Box_Number == 0) || !Settings.Default.practiceMode;
            ((Label)this.Controls.Find($"lbl{Box_Number}Position1Value", true)[0]).Text = BackgroundCode.Robots[o].Current_Loc.ToString();
            ((Label)this.Controls.Find($"lbl{Box_Number}Position1Value", true)[0]).Visible = (Box_Number == 0) || !Settings.Default.practiceMode;


            ((Label)this.Controls.Find($"lbl{Box_Number}Position2", true)[0]).Text = "Del:";
            ((Label)this.Controls.Find($"lbl{Box_Number}Position2", true)[0]).Visible = (Box_Number == 0) || !Settings.Default.practiceMode;
            ((Label)this.Controls.Find($"lbl{Box_Number}Position2Value", true)[0]).Text = BackgroundCode.Robots[o].Del_Dest.ToString();
            if (BackgroundCode.Robots[o].Del_Dest != RobotState.DEL_DEST.Select)
            {
                ((Label)this.Controls.Find($"lbl{Box_Number}Position2Value", true)[0]).Visible = (Box_Number == 0) || !Settings.Default.practiceMode;
            }
            else
            {
            ...
            if (BackgroundCode.Robots[o].Flag == 1 && BackgroundCode.Robots[o].Del_Dest != RobotState.DEL_DEST.Select)
            {
                ((Label)this.Controls.Find($"lbl{Box_Number}Position2Flag", true)[0]).Visible = (Box_Number == 0) || !Settings.Default.practiceMode;
            }
        ...
        private void InShowtimeMode(int Box_Number, int o)
        {
            ((Label)this.Controls.Find($"lbl{Box_Number}Position0", true)[0]).Text = "Del:";
            ((Label)this.Controls.Find($"lbl{Box_Number}Position0", true)[0]).Visible = (Box_Number == 0) || !Settings.Default.practiceMode;
            ((Label)this.Controls.Find($"lbl{Box_Number}Position0Value", true)[0]).Text = BackgroundCode.Robots[o].Del_Dest.ToString();
            if (BackgroundCode.Robots[o].Del_Dest != RobotState.DEL_DEST.Select)
            {
                ((Label)this.Controls.Find($"lbl{Box_Number}Position0Value", true)[0]).Visible = (Box_Number == 0) || !Settings.Default.practiceMode;
            }
            ...
            ((Label)this.Controls.Find($"lbl{Box_Number}Position2Value", true)[0]).Text = BackgroundCode.Robots[o].ClimbTDouble.ToString("0.#");
            ((Label)this.Controls.Find($"lbl{Box_Number}Position2Value", true)[0]).Visible = (Box_Number == 0) || !Settings.Default.practiceMode;
            ((Label)this.Controls.Find($"lbl{Box_Number}Position2Flag", true)[0]).Visible = false;

            ((Label)this.Controls.Find($"lbl{Box_Number}Position3", true)[0]).Text = "Status:";
            ((Label)this.Controls.Find($"lbl{Box_Number}Position3", true)[0]).Visible = (Box_Number == 0) || !Settings.Default.practiceMode;
            ((Label)this.Controls.Find($"lbl{Box_Number}Position3Value", true)[0]).Text = BackgroundCode.Robots[o].Stage_Stat.ToString();
            ((Label)this.Controls.Find($"lbl{Box_Number}Position3Value", true)[0]).Visible = (Box_Number == 0) || !Settings.Default.practiceMode;
            ...
            if (BackgroundCode.Robots[o].Stage_Stat == RobotState.STAGE_STAT.Onstage)
            {
                ...
                ((Label)this.Controls.Find($"lbl{Box_Number}Position4", true)[0]).Visible = (Box_Number == 0) || !Settings.Default.practiceMode;
                ...
                else
                {
                    ...
                    ((Label)this.Controls.Find($"lbl{Box_Number}Position4Value", true)[0]).Visible = (Box_Number == 0) || !Settings.Default.practiceMode;
                    ((Label)this.Controls.Find($"lbl{Box_Number}Position4Value", true)[0]).Text = BackgroundCode.Robots[o].Stage_Loc.ToString();
                }
            }
            ...
            ((Label)this.Controls.Find($"lbl{Box_Number}Position5", true)[0]).Visible = (Box_Number == 0) || !Settings.Default.practiceMode;
            ...
            {
                ((Label)this.Controls.Find($"lbl{Box_Number}Position5Value", true)[0]).Text = BackgroundCode.Robots[o].Harm.ToString();
                ((Label)this.Controls.Find($"lbl{Box_Number}Position5Value", true)[0]).BackColor = System.Drawing.Color.Black;
                ((Label)this.Controls.Find($"lbl{Box_Number}Position5Value", true)[0]).ForeColor = System.Drawing.Color.Yellow;
                ((Label)this.Controls.Find($"lbl{Box_Number}Position5Value", true)[0]).Visible = (Box_Number == 0) || !Settings.Default.practiceMode;
            }


            ((Label)this.Controls.Find($"lbl{Box_Number}Position6", true)[0]).Text = "Strat:";
            ((Label)this.Controls.Find($"lbl{Box_Number}Position6", true)[0]).Visible = (Box_Number == 0) || !Settings.Default.practiceMode;
            ((Label)this.Controls.Find($"lbl{Box_Number}Position6Value", true)[0]).Text = BackgroundCode.Robots[o].App_Strat.ToString();
            ...
            {
                ((Label)this.Controls.Find($"lbl{Box_Number}Position6Value", true)[0]).Visible = (Box_Number == 0) || !Settings.Default.practiceMode;
            }

            ((Label)this.Controls.Find($"lbl{Box_Number}Position7", true)[0]).Text = "Spotlit:";
            ((Label)this.Controls.Find($"lbl{Box_Number}Position7", true)[0]).Visible = (Box_Number == 0) || !Settings.Default.practiceMode;
            ...
            ((Label)this.Controls.Find($"lbl{Box_Number}Position7Value", true)[0]).Visible = (Box_Number == 0) || !Settings.Default.practiceMode;

            ((Label)this.Controls.Find($"lbl{Box_Number}Position8", true)[0]).Text = "Def:";
            ((Label)this.Controls.Find($"lbl{Box_Number}Position8", true)[0]).Visible = (Box_Number == 0) || !Settings.Default.practiceMode;
            ...
            {
                ((Label)this.Controls.Find($"lbl{Box_Number}Position8Value", true)[0]).Text = BackgroundCode.Robots[o].Def_Rat.ToString();
                ((Label)this.Controls.Find($"lbl{Box_Number}Position8Value", true)[0]).Visible = (Box_Number == 0) || !Settings.Default.practiceMode;
            }

            ((Label)this.Controls.Find($"lbl{Box_Number}Position9", true)[0]).Text = "Mics:";
            ((Label)this.Controls.Find($"lbl{Box_Number}Position9", true)[0]).Visible = (Box_Number == 0) || !Settings.Default.practiceMode;
            if (BackgroundCode.Robots[o].Mic == 10 || BackgroundCode.Robots[o].Mic == 9)
            {
                ((Label)this.Controls.Find($"lbl{Box_Number}Position9Value", true)[0]).Visible = false;
            }
            ...
            {
                ((Label)this.Controls.Find($"lbl{Box_Number}Position9Value", true)[0]).Text = BackgroundCode.Robots[o].Mic.ToString();
                ((Label)this.Controls.Find($"lbl{Box_Number}Position9Value", true)[0]).Visible = (Box_Number == 0) || !Settings.Default.practiceMode;
            }


            ((Label)this.Controls.Find($"lbl{Box_Number}Position10", true)[0]).Text = "Avo:";
            ((Label)this.Controls.Find($"lbl{Box_Number}Position10", true)[0]).Visible = (Box_Number == 0) || !Settings.Default.practiceMode;
            ...
            {
                ((Label)this.Controls.Find($"lbl{Box_Number}Position10Value", true)[0]).Text = BackgroundCode.Robots[o].Avo_Rat.ToString();
                ((Label)this.Controls.Find($"lbl{Box_Number}Position10Value", true)[0]).Visible = (Box_Number == 0) || !Settings.Default.practiceMode;
            }
        }
    }
}
